...
type PostAcccountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PostAcccountRequest) Reset() {
	*x = PostAcccountRequest{}
	mi := &file_account_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PostAcccountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostAcccountRequest) ProtoMessage() {}

func (x *PostAcccountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_account_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostAcccountRequest.ProtoReflect.Descriptor instead.
func (*PostAcccountRequest) Descriptor() ([]byte, []int) {
	return file_account_proto_rawDescGZIP(), []int{1}
}

func (x *PostAcccountRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type PostAcccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PostAcccountResponse) Reset() {
	*x = PostAcccountResponse{}
	mi := &file_account_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PostAcccountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostAcccountResponse) ProtoMessage() {}

func (x *PostAcccountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_account_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostAcccountResponse.ProtoReflect.Descriptor instead.
func (*PostAcccountResponse) Descriptor() ([]byte, []int) {
	return file_account_proto_rawDescGZIP(), []int{2}
}

func (x *PostAcccountResponse) GetAccount() *Account {
	if x != nil {
		return x.Account
	}
	return nil
...
const file_account_proto_rawDesc = "" +
	...
	"\x13PostAcccountRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"=\n" +
	"\x14PostAcccountResponse\x12%\n" +
	...
	"\aaccount\x18\x01 \x03(\v2\v.pb.AccountR\aaccount2\xd5\x01\n" +
...
var file_account_proto_goTypes = []any{
	...
	(*PostAcccountRequest)(nil),  // 1: pb.PostAcccountRequest
	(*PostAcccountResponse)(nil), // 2: pb.PostAcccountResponse
...
var file_account_proto_depIdxs = []int32{
	0, // 0: pb.PostAcccountResponse.account:type_name -> pb.Account
	0, // 1: pb.GetAccountResponse.account:type_name -> pb.Account
	0, // 2: pb.GetAccountsResponse.account:type_name -> pb.Account
	1, // 3: pb.AccountService.PostAccount:input_type -> pb.PostAcccountRequest
	...
	2, // 6: pb.AccountService.PostAccount:output_type -> pb.PostAcccountResponse
