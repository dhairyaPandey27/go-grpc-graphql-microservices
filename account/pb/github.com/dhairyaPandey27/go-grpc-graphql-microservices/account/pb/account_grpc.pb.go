...
type AccountServiceClient interface {
	PostAccount(ctx context.Context, in *PostAcccountRequest, opts ...grpc.CallOption) (*PostAcccountResponse, error)
...
func (c *accountServiceClient) PostAccount(ctx context.Context, in *PostAcccountRequest, opts ...grpc.CallOption) (*PostAcccountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PostAcccountResponse)
...
type AccountServiceServer interface {
	PostAccount(context.Context, *PostAcccountRequest) (*PostAcccountResponse, error)
...
func (UnimplementedAccountServiceServer) PostAccount(context.Context, *PostAcccountRequest) (*PostAcccountResponse, error) {
...
func _AccountService_PostAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).PostAccount(ctx, req.(*PostAcccountRequest))
	}
